<div style="background-color:hsl(148, 80%, 25%); height: 150px; display: flex; align-items: center; justify-content: center; flex-direction: column; position: relative;">
    ...
    <nav id="navigation" style="background-color: #284684; width: 80%; margin-top: 2rem; border-radius: 5rem; border: 3px solid #eee; text-align: center; padding: 10px 0; margin-bottom:-70px;">
        <span style="color: #fff;">Contributor Covenant Code of Conduct</span>
    </nav>
</div>
